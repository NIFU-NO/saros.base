testthat::test_that("attach_new_output_to_output", {
  saros.base:::attach_new_output_to_output(new_out = "New output",
                                      output = "",
                                      level = 4,
  ...
  saros.base:::attach_new_output_to_output(new_out = "New output",
                                      output = "",
                                      level = 4,
                                      grouped_data = tibble::tibble(a=1, b=1, c=1, .template_name=1),
                                      heading_line = "# New heading") |>
    testthat::expect_equal("New output")

  saros.base:::attach_new_output_to_output(new_out = "new",
                                      output = "",
                                      level = 4,
                                      grouped_data = tibble::tibble(a=1, b=1, c=1, d=1),
                                      heading_line = "# New heading") |>
