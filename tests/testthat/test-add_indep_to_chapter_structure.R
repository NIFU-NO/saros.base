...
testthat::test_that("add_indep_to_chapter_structure handles missing .variable_role", {
  ...
  testthat::expect_warning(saros.base:::add_indep_to_chapter_structure(chapter_structure))
})
...
testthat::test_that("add_indep_to_chapter_structure handles NA in .variable_role", {
